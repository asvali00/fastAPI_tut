...
from app.models import Base # sa ovim importom omogućujemo alembic-u da prati šta to fali našoj db
...
target_metadata = Base.metadata # ovdje smo proslijedili što to fali našoj bazi, ako išta fali
